package mochadick.common.network.client;
...
import mochadick.common.network.AbstractMessage.AbstractClientMessage;
...
public class SyncPlayerPropsMessage extends AbstractClientMessage<SyncPlayerPropsMessage>
{
	...
	public void process(EntityPlayer player, Side side) {
		...
		MochaDick.log.info("Synchronizing extended properties data on CLIENT");
